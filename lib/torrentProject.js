...
exports.getDailyDump = function(output, callback){
	downloadFile('https://'+base_url+'/dailydump.txt.gz', output+'.txt.gz', callback);
}

exports.getHourlyDump = function(output, callback){
	downloadFile('https://'+base_url+'/hourlydump.txt.gz', output+'.txt.gz', callback);
}
